...
▢ *TOP ${len} XP* 🧬
Kamu : *${usersExp.indexOf(m.sender) + 1}* de *${usersExp.length}*
...
▢ *TOP ${len} Limit💎* 
Kamu : *${usersLim.indexOf(m.sender) + 1}* de *${usersLim.length}*
...
▢ *TOP ${len} LEVEL* ⬆️
Kamu : *${usersLevel.indexOf(m.sender) + 1}* de *${usersLevel.length}*
